...
public:
  ...
  /// local vertex numbers (0-based) of the edges / faces of an element type
  inline static FlatArray<const ELEMENT_EDGE> GetEdges (ELEMENT_TYPE et);
  inline static FlatArray<const ELEMENT_FACE> GetFaces (ELEMENT_TYPE et);
...
inline FlatArray<const ELEMENT_EDGE> MeshTopology :: GetEdges (ELEMENT_TYPE et)
{
  return element_info::Edges (et);
}

inline FlatArray<const ELEMENT_FACE> MeshTopology :: GetFaces (ELEMENT_TYPE et)
{
  return element_info::Faces (et);
}
